...
import { getLocalizedName, getPokemonSpecies, type PokemonBasicData } from "@/lib/pokeapi"
        ...
        {!pokemon1Id ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Pokemon 2 */}
              <div className="bg-secondary/30 p-4 retro-border text-center relative">
...
function PokemonComparisonSelectItem({ pokemon, onSelect, isSelected, language }: PokemonComparisonSelectItemProps) {
  ...
  return (
    <button
      ...
      className={`w-full p-2 flex items-center gap-2 hover:bg-secondary/50 transition-colors text-left ${
